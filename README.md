...
## Usage
### Initialization
Enter your access token and select your API endpoint. You can get it on your account [here](https://www.ai-compare.com/accounts/login/?next=/my_apis/my_account).
```python
import requests
